...
var require_objectWithoutPropertiesLoose2 = __commonJS2({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/objectWithoutPropertiesLoose.js"(exports, module) {
  function _objectWithoutPropertiesLoose(r, e) {
    if (null == r) return {};
    var t = {};
    for (var n in r) if ({}.hasOwnProperty.call(r, n)) {
...
var require_objectWithoutProperties2 = __commonJS2({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/objectWithoutProperties.js"(exports, module) {
...
var import_objectWithoutProperties2 = __toESM3(require_objectWithoutProperties2(), 1);
var import_objectSpread25 = __toESM3(require_objectSpread22(), 1);
var _excluded2 = ["cursor", "direction"];
function getQueryKeyInternal(path, input, type) {
  ...
  if (type === "infinite" && isObject(input) && ("direction" in input || "cursor" in input)) {
    const { cursor: _, direction: __ } = input, inputWithoutCursorAndDirection = (0, import_objectWithoutProperties2.default)(input, _excluded2);
    return [splitPath, {
      input: inputWithoutCursorAndDirection,
      type: "infinite"
    }];
  }
  return [splitPath, (0, import_objectSpread25.default)((0, import_objectSpread25.default)({}, typeof input !== "undefined" && input !== skipToken && { input }), type && type !== "any" && { type })];
}
...
var TRPCClientError = class TRPCClientError2 extends Error {
  ...
  static from(_cause, opts = {}) {
    ...
    if (isTRPCClientError(cause)) {
      if (opts.meta) cause.meta = (0, import_objectSpread26.default)((0, import_objectSpread26.default)({}, cause.meta), opts.meta);
      return cause;
    }
    if (isTRPCErrorResponse(cause)) return new TRPCClientError2(cause.error.message, (0, import_objectSpread26.default)((0, import_objectSpread26.default)({}, opts), {}, { result: cause }));
    return new TRPCClientError2(getMessageFromUnknownError(cause, "Unknown error"), (0, import_objectSpread26.default)((0, import_objectSpread26.default)({}, opts), {}, { cause }));
  }
};
...
async function fetchHTTPResponse(opts) {
  ...
  const headers = (0, import_objectSpread27.default)((0, import_objectSpread27.default)((0, import_objectSpread27.default)({}, opts.contentTypeHeader ? { "content-type": opts.contentTypeHeader } : {}), opts.trpcAcceptHeader ? { "trpc-accept": opts.trpcAcceptHeader } : void 0), resolvedHeaders);
...
var universalRequester = (opts) => {
  if ("input" in opts) {
    ...
    if (isFormData(input)) {
      ...
      return httpRequest((0, import_objectSpread28.default)((0, import_objectSpread28.default)({}, opts), {}, {
  ...
  return () => {
    return ({ op }) => {
      return observable((observer) => {
        ...
        const request = universalRequester((0, import_objectSpread28.default)((0, import_objectSpread28.default)({}, resolvedOpts), {}, {
          type,
          path,
          input,
          signal: op.signal,
    ...
    const batchLoader = (type) => {
      return {
        validate(batchOps) {
          ...
          const url = getUrl((0, import_objectSpread29.default)((0, import_objectSpread29.default)({}, resolvedOpts), {}, {
            type,
            path,
            inputs,
            signal: null
        ...
        async fetch(batchOps) {
          ...
          const res = await jsonHttpRequester((0, import_objectSpread29.default)((0, import_objectSpread29.default)({}, resolvedOpts), {}, {
            path,
            inputs,
            type,
            headers() {
...
function constructPartsAndArgs(opts) {
  ...
  else args.push((0, import_objectSpread210.default)({
    input,
    result: opts.result,
...
var defaultLogger = ({ c = console, colorMode = "css", withContext }) => (props) => {
  ...
  const { parts, args } = constructPartsAndArgs((0, import_objectSpread210.default)((0, import_objectSpread210.default)({}, props), {}, {
    colorMode,
    input,
    withContext
  }));
...
function loggerLink(opts = {}) {
  ...
  return () => {
    return ({ op, next }) => {
      return observable((observer) => {
        if (enabled((0, import_objectSpread210.default)((0, import_objectSpread210.default)({}, op), {}, { direction: "up" }))) logger((0, import_objectSpread210.default)((0, import_objectSpread210.default)({}, op), {}, { direction: "up" }));
        const requestStartTime = Date.now();
        function logResult(result) {
          const elapsedMs = Date.now() - requestStartTime;
          if (enabled((0, import_objectSpread210.default)((0, import_objectSpread210.default)({}, op), {}, {
            direction: "down",
            result
          }))) logger((0, import_objectSpread210.default)((0, import_objectSpread210.default)({}, op), {}, {
            direction: "down",
            elapsedMs,
            result
          }));
...
var import_defineProperty5 = __toESM4(require_defineProperty3(), 1);
var import_objectSpread211 = __toESM4(require_objectSpread23(), 1);
var WsClient = class {
  constructor(opts) {
    ...
    const lazyOptions = (0, import_objectSpread211.default)((0, import_objectSpread211.default)({}, lazyDefaults), opts.lazy);
    ...
    this.activeConnection = new WsConnection({
      ...
      urlOptions: opts,
      keepAlive: (0, import_objectSpread211.default)((0, import_objectSpread211.default)({}, keepAliveDefaults), opts.keepAlive)
    });
  ...
  */
  request({ op: { id, type, path, input, signal }, transformer, lastEventId }) {
    return observable((observer) => {
      ...
      }, (0, import_objectSpread211.default)((0, import_objectSpread211.default)({}, observer), {}, { next(event) {
...
var import_defineProperty6 = __toESM4(require_defineProperty3(), 1);
...
var require_asyncIterator2 = __commonJS3({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/asyncIterator.js"(exports, module) {
...
var import_objectSpread2$14 = __toESM4(require_objectSpread23(), 1);
...
var require_usingCtx2 = __commonJS3({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/usingCtx.js"(exports, module) {
  function _usingCtx() {
    var r = "function" == typeof SuppressedError ? SuppressedError : function(r$1, e$1) {
      var n$1 = Error();
      return n$1.name = "SuppressedError", n$1.error = r$1, n$1.suppressed = e$1, n$1;
...
var require_OverloadYield2 = __commonJS3({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/OverloadYield.js"(exports, module) {
  function _OverloadYield(e, d) {
    this.v = e, this.k = d;
  }
  module.exports = _OverloadYield, module.exports.__esModule = true, module.exports["default"] = module.exports;
} });
var require_awaitAsyncGenerator2 = __commonJS3({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/awaitAsyncGenerator.js"(exports, module) {
...
var require_wrapAsyncGenerator2 = __commonJS3({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/wrapAsyncGenerator.js"(exports, module) {
...
var import_usingCtx2 = __toESM4(require_usingCtx2(), 1);
var import_awaitAsyncGenerator2 = __toESM4(require_awaitAsyncGenerator2(), 1);
var import_wrapAsyncGenerator2 = __toESM4(require_wrapAsyncGenerator2(), 1);
var import_objectSpread212 = __toESM4(require_objectSpread23(), 1);
          ...
          try {
            ...
            while (true) try {
              ...
              while (true) {
                ...
                observer.next({ result: (0, import_objectSpread212.default)((0, import_objectSpread212.default)({}, chunk), {}, { data: transformChunk(chunk.data) }) });
              }
            } catch (_) {
              _usingCtx4.e = _;
            } finally {
...
var import_objectSpread2$23 = __toESM3(require_objectSpread22(), 1);
function getClientArgs(queryKey, opts, infiniteParams) {
  ...
  if (infiniteParams) {
    var _input;
    input = (0, import_objectSpread2$23.default)((0, import_objectSpread2$23.default)((0, import_objectSpread2$23.default)({}, (_input = input) !== null && _input !== void 0 ? _input : {}), infiniteParams.pageParam ? { cursor: infiniteParams.pageParam } : {}), {}, { direction: infiniteParams.direction });
  }
  return [
    path.join("."),
    input,
...
var require_asyncIterator3 = __commonJS2({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/asyncIterator.js"(exports, module) {
  function _asyncIterator$1(r) {
    var n, t, o, e = 2;
    for ("undefined" != typeof Symbol && (t = Symbol.asyncIterator, o = Symbol.iterator); e--; ) {
      if (t && null != (n = r[t])) return n.call(r);
...
var import_asyncIterator3 = __toESM3(require_asyncIterator3(), 1);
...
async function buildQueryFromAsyncIterable(asyncIterable, queryClient, queryKey) {
  ...
  var _iteratorError;
  try {
    for (var _iterator = (0, import_asyncIterator3.default)(asyncIterable), _step; _iteratorAbruptCompletion = !(_step = await _iterator.next()).done; _iteratorAbruptCompletion = false) {
...
var import_objectSpread2$15 = __toESM3(require_objectSpread22(), 1);
  ...
  return {
    infiniteQueryOptions: (path, queryKey, opts$1) => {
      ...
      const queryFn = async (queryFnContext) => {
        var _opts$trpc;
        const actualOpts = (0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, { trpc: (0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1 === null || opts$1 === void 0 ? void 0 : opts$1.trpc), (opts$1 === null || opts$1 === void 0 || (_opts$trpc = opts$1.trpc) === null || _opts$trpc === void 0 ? void 0 : _opts$trpc.abortOnUnmount) ? { signal: queryFnContext.signal } : { signal: null }) });
      ...
      return Object.assign(infiniteQueryOptions((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, {
    ...
    queryOptions: (path, queryKey, opts$1) => {
      ...
      const queryFn = async (queryFnContext) => {
        var _opts$trpc2;
        const actualOpts = (0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, { trpc: (0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1 === null || opts$1 === void 0 ? void 0 : opts$1.trpc), (opts$1 === null || opts$1 === void 0 || (_opts$trpc2 = opts$1.trpc) === null || _opts$trpc2 === void 0 ? void 0 : _opts$trpc2.abortOnUnmount) ? { signal: queryFnContext.signal } : { signal: null }) });
        const result = await untypedClient.query(...getClientArgs(queryKey, actualOpts));
        if (isAsyncIterable(result)) return buildQueryFromAsyncIterable(result, queryClient, queryKey);
        return result;
      };
      return Object.assign(queryOptions((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, {
        initialData: opts$1 === null || opts$1 === void 0 ? void 0 : opts$1.initialData,
        queryKey,
        queryFn: inputIsSkipToken ? skipToken : queryFn
      })), { trpc: createTRPCOptionsResult({ path }) });
    ...
    fetchQuery: (queryKey, opts$1) => {
      return queryClient.fetchQuery((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, {
        queryKey,
    ...
    fetchInfiniteQuery: (queryKey, opts$1) => {
      ...
      return queryClient.fetchInfiniteQuery((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, {
        queryKey,
    ...
    prefetchQuery: (queryKey, opts$1) => {
      return queryClient.prefetchQuery((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, {
        queryKey,
        queryFn: () => untypedClient.query(...getClientArgs(queryKey, opts$1))
      }));
    },
    prefetchInfiniteQuery: (queryKey, opts$1) => {
      ...
      return queryClient.prefetchInfiniteQuery((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, {
        queryKey,
        queryFn: ({ pageParam, direction }) => {
          return untypedClient.query(...getClientArgs(queryKey, opts$1, {
            pageParam,
    ...
    ensureQueryData: (queryKey, opts$1) => {
      return queryClient.ensureQueryData((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, opts$1), {}, {
        queryKey,
        queryFn: () => untypedClient.query(...getClientArgs(queryKey, opts$1))
      }));
    },
    invalidateQueries: (queryKey, filters, options) => {
      return queryClient.invalidateQueries((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, filters), {}, { queryKey }), options);
    },
    resetQueries: (queryKey, filters, options) => {
      return queryClient.resetQueries((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, filters), {}, { queryKey }), options);
    },
    refetchQueries: (queryKey, filters, options) => {
      return queryClient.refetchQueries((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, filters), {}, { queryKey }), options);
    },
    ...
    setQueriesData: (queryKey, filters, updater, options) => {
      return queryClient.setQueriesData((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, filters), {}, { queryKey }), updater, options);
    },
    ...
    isMutating: (filters) => {
      return queryClient.isMutating((0, import_objectSpread2$15.default)((0, import_objectSpread2$15.default)({}, filters), {}, { exact: true }));
    }
  };
}
var import_objectSpread213 = __toESM3(require_objectSpread22());
...
function createRootHooks(config) {
  ...
  const TRPCProvider = (props) => {
    ...
    const contextValue = React.useMemo(() => (0, import_objectSpread213.default)({
      abortOnUnmount,
      queryClient,
      client,
  ...
  function useSSRQueryOptionsIfNeeded(queryKey, opts) {
    ...
    return ssrState && ssrState !== "mounted" && ((_queryClient$getQuery = queryClient.getQueryCache().find({ queryKey })) === null || _queryClient$getQuery === void 0 ? void 0 : _queryClient$getQuery.state.status) === "error" ? (0, import_objectSpread213.default)({ retryOnMount: false }, opts) : opts;
  }
  function useQuery$1(path, input, opts) {
    ...
    const ssrOpts = useSSRQueryOptionsIfNeeded(queryKey, (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, defaultOpts), opts));
    ...
    const hook = useQuery((0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, ssrOpts), {}, {
      queryKey,
      queryFn: isInputSkipToken ? input : async (queryFunctionContext) => {
        const actualOpts = (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, ssrOpts), {}, { trpc: (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, ssrOpts === null || ssrOpts === void 0 ? void 0 : ssrOpts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : { signal: null }) });
  ...
  function usePrefetchQuery$1(path, input, opts) {
    ...
    usePrefetchQuery((0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts), {}, {
      queryKey,
      queryFn: isInputSkipToken ? input : (queryFunctionContext) => {
        const actualOpts = { trpc: (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts === null || opts === void 0 ? void 0 : opts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : {}) };
  ...
  function useSuspenseQuery$1(path, input, opts) {
    ...
    const hook = useSuspenseQuery((0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts), {}, {
      queryKey,
      queryFn: (queryFunctionContext) => {
        const actualOpts = (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts), {}, { trpc: (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts === null || opts === void 0 ? void 0 : opts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : { signal: null }) });
        return context.client.query(...getClientArgs(queryKey, actualOpts));
      }
    }), context.queryClient);
    hook.trpc = useHookResult({ path });
  ...
  function useMutation$1(path, opts) {
    ...
    const hook = useMutation((0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts), {}, {
      mutationKey,
      mutationFn: (input) => {
  ...
  function useSubscription(path, input, opts) {
    ...
    const reset = React.useCallback(() => {
      ...
      if (!enabled) {
        updateState(() => (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, initialStateIdle), {}, { reset }));
        return;
      }
      updateState(() => (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, initialStateConnecting), {}, { reset }));
      const subscription = client.subscription(path.join("."), input !== null && input !== void 0 ? input : void 0, {
        onStarted: () => {
          ...
          updateState((prev) => (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, prev), {}, {
            status: "pending",
            error: null
          }));
        },
        ...
        onConnectionStateChange: (result) => {
          updateState((prev) => {
            switch (result.state) {
              case "idle":
                return (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, prev), {}, {
                  status: result.state,
                  error: null,
                  data: void 0
                });
    ...
    const resultRef = React.useRef(enabled ? (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, initialStateConnecting), {}, { reset }) : (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, initialStateIdle), {}, { reset }));
  ...
  function useInfiniteQuery$1(path, input, opts) {
    ...
    const hook = useInfiniteQuery((0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, ssrOpts), {}, {
  ...
  function usePrefetchInfiniteQuery$1(path, input, opts) {
    ...
    usePrefetchInfiniteQuery((0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts), {}, {
      ...
      queryFn: isInputSkipToken ? input : (queryFunctionContext) => {
        ...
        const actualOpts = (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, ssrOpts), {}, { trpc: (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, ssrOpts === null || ssrOpts === void 0 ? void 0 : ssrOpts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : {}) });
        return context.client.query(...getClientArgs(queryKey, actualOpts, {
  ...
  function useSuspenseInfiniteQuery$1(path, input, opts) {
    ...
    const hook = useSuspenseInfiniteQuery((0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, opts), {}, {
  ...
  const useQueries$1 = (queriesCallback, options) => {
    ...
    return useQueries({
      queries: queries.map((query) => (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, query), {}, { queryKey: query.queryKey })),
  ...
  const useSuspenseQueries$1 = (queriesCallback) => {
    ...
    const proxy = createUseQueries(client);
    const queries = queriesCallback(proxy);
    const hook = useSuspenseQueries({ queries: queries.map((query) => (0, import_objectSpread213.default)((0, import_objectSpread213.default)({}, query), {}, {
